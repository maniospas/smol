...
#define SMOLAMBDA_RUNTIME_MESSAGE(num_threads) printf("\033[30;44m smoλ \033[0m https://github.com/maniospas/smol\n\033[30;44m smoλ \033[0m %d co-routine threads by --runtime auto  (also shows this message)\n\n", num_threads);
#include "threads.h"
#else
#define SMOLAMBDA_RUNTIME_MESSAGE(num_threads) printf("\033[30;44m smoλ \033[0m https://github.com/maniospas/smol\n\033[30;44m smoλ \033[0m single threaded by --runtime auto  (also shows this message)\n\n");
#include "eager.h"
#endif