...
@about String  "A union between str and constant strings <code>cstr</code>.Constant strings are those that generated by default when enclosing some text in quotients. Example usage: <code>smo foo(String _s) s = _s:str ... --</code>"
@about IndependentString "A copy of the String union that can be used when a second argument is needed with a string of a different type."
