...
@about read    
"Reads several string and primitive types from the console. The user "
"needs to press enter after entering the input. Invalid inputs create "
"service failures, including in the case where the number is too large "
"to properly process. Example: "
...
@about convert 
"Converts a String representation to various numeric formats. This is "
"lightweight and does not consume additional memory. The current service "
"fails if the conversion is not possible. Example: "
"<pre>x = f64.convert(\"1.2\")"
"\nprint(x+1) // prints `2.2`</pre>"
