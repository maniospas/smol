...
struct main__213__state{errcode err;};
void main__213(void *__void__state);

void main__213(void *__void__state){
errcode __result__errocode=0;
struct main__213__state *__state=(struct main__213__state*)__void__state;
f64 __gG__message=0;
...
ptr __ZG__shapes____OF__surface=0;
f64 __fG____MF__x=0;
u64 __dG__shapes__types__dynamic____buffer_alignment=0;
ptr __ZG__shapes____QF__dynamic=0;
ptr __ZG__shapes____PF__dynamic=0;
ptr __ZG__shapes____QF__surface=0;
ptr __ZG__shapes____OF__dynamic=0;
u64 __ZG__shapes__types__dynamic____buffer_alignment=0;
f64 __fG____LF____IF__y=0;
ptr __ZG__shapes____RF__dynamic=0;
u64 __ZG____bF=0;
f64 __fG____LF____IF__x=0;
ptr __ZG__shapes____RF__surface=0;
u64 __ZG____aF=0;
u64 __ZG__type=0;
u64 __ZG____cF=0;
u64 __ZG____dF__x=0;
...
ptr __ZG__shapes____PF__surface=0;
...
u64 __ZG__shapes__types__dynamic____buffer_size=0;
f64 __YG__side=0;
...
f64 __JG=0;
ptr __ZG__shapes__circles__surface=0;
u64 __UG____0D__x=0;
...
ptr __ZG__shapes__types__dynamic=0;
...
nominal __ZG__shapes____NF=0;
u64 __SG__pos=0;
ptr __ZG__shapes__lookups__surface=0;
f64 __eG=0;
...
ptr __ZG__shapes__squares__dynamic=0;
ptr __QG__shapes____PF__dynamic=0;
ptr __ZG__shapes__squares__surface=0;
u64 __LG____AG=0;
ptr __ZG__shapes__circles__dynamic=0;
ptr __ZG__shapes__types__surface=0;
ptr __ZG__shapes__lookups__dynamic=0;
u64 __ZG__pos=0;
...
__GG____OF__dynamic = __runtime_calloc(3*sizeof(u64)) ;
 ...
 goto __YG____end ;
 __YG____end :
 __ZG__shapes__squares__dynamic = shapes__squares__dynamic ;
 __ZG__shapes__squares__surface = shapes__squares__surface ;
 __ZG__shapes__circles__dynamic = shapes__circles__dynamic ;
 __ZG__shapes__circles__surface = shapes__circles__surface ;
 __ZG__shapes__types__dynamic = shapes__types__dynamic ;
 __ZG__shapes__types__surface = shapes__types__surface ;
 __ZG__shapes__lookups__dynamic = shapes__lookups__dynamic ;
 __ZG__shapes__lookups__surface = shapes__lookups__surface ;
 __ZG__pos = i ;
 __ZG____YF__side = __YG__side ;
 if(! __ZG__shapes__types__dynamic )goto __ZG____ZF ;
 __ZG__shapes__types__dynamic____buffer_alignment = 1 ;
 __ZG__shapes__types__dynamic____buffer_size = ((u64*) __ZG__shapes__types__dynamic )[1] ;
 if( __ZG__pos >= __ZG__shapes__types__dynamic____buffer_size )goto __ZG____ZF ;
 memcpy(& __ZG____bF , &((u64*)((u64*) __ZG__shapes__types__dynamic )[0])[ __ZG__pos * __ZG__shapes__types__dynamic____buffer_alignment +0], sizeof( u64 )) ;
...
int main() {
struct main__213__state __main_args={0};
__smolambda_initialize_service_tasks(main__213, &__main_args);
